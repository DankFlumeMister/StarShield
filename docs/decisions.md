...
- **具体电池型号与尺寸**（决定外壳电池仓）。🔴 **2026-09-17 更新：容量已定为 2×5000mAh 并联（10000mAh）**，
  原「3000mAh 三条尺寸路线 + 605080 推荐（仓 6.5×51×84mm、机壳深 ≥8.5–9mm）」**已作废**。
  新规格：单块参考 `LP955465`（9.5×54×66mm、100g），两块并排 ⇒
  **电池仓约 10.5×110×68mm、机壳深 ≥11mm**。
  采购硬约束（一体化 1S2P 单 PCM、过流阈值 >2A、AWG #24、JST-PH）见 `docs/power-architecture.md` §3.6。
