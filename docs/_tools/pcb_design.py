...
CONTROL = {
    ...
    # ⚠️ y = 5.5：USB-C 的插口需要露出板边（壳体上沿开缺口），但**焊盘必须留在板内**
    #    （原取 4.8 时焊盘离板边仅 0.03 mm，DRC copper_edge_clearance 报 error 且会被切掉）。
    "J1": (210.00, 5.50, 0.0),     # USB-C：开口朝板外（-Y），焊盘离板边 ≥0.5 mm
    "R1": (228.00, 6.00, 0.0),     # CC1 5.1k
    "R2": (228.00, 11.00, 0.0),    # CC2 5.1k
    "F1": (240.00, 6.00, 0.0),     # 2 A hold PTC（P15）
